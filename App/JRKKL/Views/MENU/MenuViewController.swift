...
class MenuViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    private var items: [String] = ["", "ホーム", "JR九州アプリ「JR九州」", "JR九州HPトップ", "九州産業大学アプリ「KSU」", "九州産業大学HPトップ", "", "九州の旅とお取り寄せ", "", "Twitter（#香椎線）", "Instagram（香椎地区統括）", "Instagram（客室乗務員）", "Facebook（鉄道プロモ）", "JR九州公式LINEアカウント", "TikTok（#香椎線）", "", "バージョン：\(Bundle.main.object(forInfoDictionaryKey: "CFBundleShortVersionString") as? String ?? "") (\(Bundle.main.object(forInfoDictionaryKey: "CFBundleVersion") as? String ?? ""))", ""]
